# -Inverse-Entropy-Project-About-A-New-Algorithmn
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
在此仓库中，我希望写出一个算法，它的核心目的是增进用户福祉。我非常欢迎任何意见和讨论。
In this repository, I hope to write an algorithm whose core purpose is to enhance user well-being. I warmly welcome any comments and discussions.
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
我在此处起草了一份数字时代的“希波克拉底誓言”，它欢迎任何的探讨，补充和修正。我这么做是因为相信技术一定要被置于伦理之下，而维护人类的心智安全是每一个项目参与者的义务。

I have drafted a 'Hippocratic Oath for the Digital Age' here, which welcomes any discussion, additions, and corrections. I do this because I believe that technology must be placed under ethics, and it is the duty of every project participant to safeguard the mental well-being of humanity.

在我构建、应用或维护任何能影响人类认知的系统时，我谨以人格与职业尊严宣誓：
1. 首要忠诚：我的算法最终解释权与受益权，归于全体人类，绝不将其让渡于任何特定权力、资本或意识形态。
2. 不伤害原则：我绝不允许我的创造物被用于情绪操纵、认知剥削、成瘾设计或任何其他已知会损害人类心智自主与福祉的目的。
3. 知情同意：我将确保系统的运作机制对用户最大限度的透明，保障他们在知情的前提下，与算法进行自主的、有尊严的互动。
